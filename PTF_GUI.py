...
if uploaded_file is not None:
    ...
    if "Brunswick" in model_options:
        ...
        p0_Brunswick = [0.01, 0.05, 1.5, 0.4, 0.1, 6.80]
        bounds_Brunswick = ([1e-5,0.0,1.01,0.1,0.0,6.79],[1.0,0.4,15.0,1.0,0.5,6.81])
    ...
    if "PDI" in model_options:
        ...
        p0_PDI = [0.01, 0.05, 1.5, 0.4, 6.80]
        bounds_PDI = ([1e-5,0.0,1.01,0,6.79],[1.0,0.4,15.0,0.8,6.81])
